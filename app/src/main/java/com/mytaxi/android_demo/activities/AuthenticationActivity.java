...
//                }
                    ...
                    View view = findViewById(android.R.id.content);
                    Snackbar.make(view, R.string.message_username_empty, Snackbar.LENGTH_LONG).show();
                    Log.i(LOG_TAG, "Failed login with user: " + username);
                } else if(password.isEmpty()) {
                    View view = findViewById(android.R.id.content);
                    Snackbar.make(view, R.string.message_password_empty, Snackbar.LENGTH_LONG).show();
                    Log.i(LOG_TAG, "Failed login with user: " + username);
                } else if (!mUser.match(username, sha256)){
                    View view = findViewById(android.R.id.content);
                    Snackbar.make(view, R.string.message_username_password_invalid, Snackbar.LENGTH_LONG).show();
                    Log.i(LOG_TAG, "Failed login with user: " + username);
                } else {
                    View view = findViewById(android.R.id.content);
                    Snackbar.make(view, R.string.message_login_fail, Snackbar.LENGTH_LONG).show();
